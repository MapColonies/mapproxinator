...
export class PollManager {
  ...
  private readonly frequencyTimeOutMS: number;
  ...
  public constructor(
    ...
    this.frequencyTimeOutMS = this.config.get<IPollConfig>('poll').timeout.frequencyMilliseconds;
